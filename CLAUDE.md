...
(501 for a `NotImplementedError` placeholder) inside that span, timeouts answer 504. Default
nodes still stubbed and named by issue: guard (#18), understand passthrough (#27), rerank_score =
fused_score (#26), gate on the stub score (#19), assemble (#20), generate (#21), check_output
(#22), respond minimal (#23), so `/ask` on a passing question returns 501 until #20/#21 land.
